...
#### `uploadMedia(file: Blob): Promise<string>`
...
This callback is triggered before `uploadMedia` and can be used to show some UI that indicates an upload is in progress.
